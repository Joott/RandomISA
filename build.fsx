...
module ProjectInfo = 
    ...
    let project = "RandomISA"

    let testProject = "tests/RandomISA.Tests/RandomISA.Tests.fsproj"

    let summary = "Random ISA-JSON proteomics assay generator"

    let solutionFile  = "RandomISA.sln"
    ...
    let gitName = "RandomISA"

    let website = "/RandomISA"

    let pkgDir = "pkg"

    let release = ReleaseNotes.load "RELEASE_NOTES.md"

    let projectRepo = "https://github.com/Joott/RandomISA"
